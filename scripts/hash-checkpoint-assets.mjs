...
const HASHED_SCRIPTS = ['config.js', 'version.js', 'devflag.js', 'graph.js', 'store.js', 'guidance.js', 'templates.js', 'changelog.js', 'lib.js', 'ai.js', 'report.js', 'selftest.js', 'app.js'];
